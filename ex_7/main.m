...
delT = 1; % Time step
F = [1 0 delT 0; 0 1 0 delT; 0 0 1 0; 0 0 0 1]; % State transition
proNoise = 0.01; % Process noise
var_x =  (delT ^ 3) / 3; % variance in position
var_v = delT; % variance in velocity
cov_xv = (delT ^ 2) / 2; % covariance between position and 
